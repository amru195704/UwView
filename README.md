...
| **探して、画面で読むまで** | `rg` ＋ klogg | 108.1秒 | **`uvf … -open` 53.69秒** | **2.01倍** |
...
> 語は `東京`（94,979件）。**[条件と全データ →](https://uvp.y42u.net/benchmarks/)**
...
**コマンドが終わってから一覧が出るまで 0.18秒**です（50GB・実測）。画面は、受け取った位置を並べるだけだからです。
